...
namespace EliteDining.DAL.Migrations
{
    ...
    [Migration("20231117214205_Contact")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EliteDining.DAL.Models.Bill", b =>
                {
                    ...
                    b.HasIndex(new[] { "CustId" }, "IX_BILL_CustID");

                    b.ToTable("BILL", (string)null);
                });

            modelBuilder.Entity("EliteDining.DAL.Models.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EliteDining.DAL.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EliteDining.DAL.Models.Food", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeeId" }, "IX_FOOD_EmployeeID");
            ...
            modelBuilder.Entity("EliteDining.DAL.Models.Order", b =>
                {
                    ...
                    b.HasIndex(new[] { "CustId" }, "IX_ORDER_CustID");

                    b.HasIndex(new[] { "EmployeeId" }, "IX_ORDER_EmployeeID");

                    b.HasIndex(new[] { "FoodId" }, "IX_ORDER_FoodID");
            ...
            modelBuilder.Entity("EliteDining.DAL.Models.Payment", b =>
                {
                    ...
                    b.HasIndex(new[] { "CustId" }, "IX_PAYMENT_CustID");
            ...
            modelBuilder.Entity("EliteDining.DAL.Models.Table", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeeId" }, "IX_TABLE_EmployeeID");
